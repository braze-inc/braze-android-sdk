...
class CustomBrazeDeeplinkHandler : IBrazeDeeplinkHandler {
    ...
    override fun getIntentFlags(intentFlagPurpose: IntentFlagPurpose): Int = BrazeDeeplinkHandler().getIntentFlags(intentFlagPurpose)
    ...
    override fun createUriActionFromUrlString(
        ...
        channel: Channel,
    ): UriAction? = BrazeDeeplinkHandler().createUriActionFromUrlString(url, extras, openInWebView, channel)
    ...
    override fun createUriActionFromUri(
        ...
        openInWebView: Boolean,
        channel: Channel,
    ): UriAction = BrazeDeeplinkHandler().createUriActionFromUri(uri, extras, openInWebView, channel)

    class CustomUriAction(
        uriAction: UriAction,
    ) : UriAction(uriAction) {
        override fun openUriWithActionView(
            context: Context,
            uri: Uri,
            extras: Bundle?,
        ) {
